...
function Section5() {
  return (
    <div className="px-4 py-0 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 pt-8 -mb-5  ">
      <div>
        ...
        <div className=" flex justify-center text-center md:px-56 py-6 ">
          ...
          <p className="text-base text-[#797979] md:text-lg">
            Our tailored app solutions across diverse industry verticals that
            redefine how industries engage and excel in the digital era.
          </p>
        </div>
      </div>

      <div className=" grid grid-cols-2 md:grid-cols-6 gap-8  py-6">
