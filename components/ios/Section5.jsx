...
function Section5() {
  return (
    <div className="px-4 py-0 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 py-8 pb-10 ">
      <div>
        ...
        <div className=" flex justify-center text-center md:px-56 py-6 ">
          ...
          <p className="text-base text-[#797979] md:text-lg">
            We serve a diverse range of industries with our expert iOS app
            development solutions, tailored to enhance efficiency and drive
            innovation.
          </p>
        </div>
      </div>
