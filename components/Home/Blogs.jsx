...
function Blogs() {
  ...
  return (
    <div className="bg-[#EFECFF] py-8">
      <div className="px-4 py-6 pt-10 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8   ">
        <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
          ...
          <p className="text-base text-[#797979] md:text-lg text-center">
