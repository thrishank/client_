        ...
        <div>
          <div className="flex flex-col justify-start items-start relative">
            ...
            <p className="flex-grow-0 flex-shrink-0 my-4 text-base text-left text-[#797979]">
              Whether you're an educational institution, edtech startup, or
              individual educator, Overninja is your trusted partner for
              education app development. Let's collaborate and create a
              transformative app that empowers learners, educators, and
              institutions to thrive in the digital age of education. Contact us
              today to get started on your education app journey!
            </p>
          </div>
        </div>
