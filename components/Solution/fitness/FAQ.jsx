    ...
    <div class="px-4 py-10 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 ">
      ...
      <div className=" grid grid-cols-1 md:grid-cols-12">
        ...
        <div className=" md:col-span-8">
          <div class="space-y-4">
            <Item title="What are the essential features of a fitness app?">
              Essential features include workout tracking, goal setting,
              progress monitoring, exercise libraries, personalized workout
              plans, performance analytics, social integration, and community
              features.
            </Item>
            <Item title="How long does it take to develop a fitness app?">
              ...
              months to a year to develop a fully functional fitness app.
            </Item>
            <Item title="What factors influence the cost of fitness app development?">
            ...
            <Item title="How can a fitness app monetize its content?">
              Monetization strategies include subscription-based models,
              advertising, in-app purchases for premium features or content,
              sponsorships, partnerships with fitness brands, and virtual
              training services.
            </Item>
            <Item title="What post-launch support is provided for fitness apps?">
