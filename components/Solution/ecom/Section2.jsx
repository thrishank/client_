        ...
        <div>
          <div className="flex flex-col justify-start items-start relative">
            <p className="flex-grow-0 flex-shrink-0  text-4xl font-semibold text-left text-[#040222]">
              Let's Transform Your Ecommerce Vision into Reality!
            </p>

            <p className="flex-grow-0 flex-shrink-0 my-4 text-base text-left text-[#797979]">
              Whether you're a small boutique or a large enterprise, Overninja
              is your trusted partner for ecommerce app development. Let's
              collaborate and create a powerful ecommerce app that drives sales,
              enhances customer engagement, and propels your business to new
              heights. Contact us today to get started on your ecommerce
              journey!
            </p>
          </div>
        </div>
