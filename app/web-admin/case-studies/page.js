...
function page() {
  ...
  useEffect(() => {
    fetch(`${NEXT_PUBLIC_BACKEND_URL}/case-studies/titles`)
  ...
  const handleDelete = async (url) => {
    try {
      const response = await fetch(
        `${NEXT_PUBLIC_BACKEND_URL}/case-studies-delete/${url}`,
        {
          method: "DELETE",
        }
      );
        ...
        <div className="col-span-10 overflow-y-scroll">
          <div className=" p-8">
            <div className=" flex justify-between">
              <h2 className=" text-3xl ">Case Studies</h2>
              <Link href={"/web-admin/case-studies/new-post"}>
              ...
              {postTitles.map((post, index) => (
                ...
                >
                  ...
                  <div className=" flex flex-row gap-4">
                    ...
                    <div className="gap-4">
                      <Link href={`/case-studies/${post.url}`}>
                        <button className="py-2 px-6 bg-blue-500 text-white">
                          View
                        </button>
                      </Link>
                      <Link href={`/web-admin/case-studies/edit/${post.url}`}>
